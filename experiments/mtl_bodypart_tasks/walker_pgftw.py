...
for i in range(num_seeds):
      ...
      for task_id in range(num_tasks):
            ...
            baseline_mtl[task_id] = MLPBaseline(e[task_id].spec, reg_coef=1e-3, batch_size=64, epochs=2, learn_rate=1e-3,use_gpu=True)
            
      policy_mtl = LinearPolicyLPGFTW(e[0].spec, k=1, max_k=10, seed=SEED)
      agent_mtl = NPGFTW(e, policy_mtl, baseline_mtl, normalized_step_size=0.1, seed=SEED, save_logs=True, new_col_mode='max_k')
