...
job_name_stl = 'results/halfcheetah_stl_bodyparts_exp'
...
for i in range(num_seeds):
      ...
      for task_id in range(num_tasks):            
            ...
            agent_stl = NPG(e[task_id], policy_stl[task_id], baseline_stl[task_id], normalized_step_size=0.01, seed=SEED, save_logs=False)
            agent_stl.set_task(task_id)
            eval_paths = trajectory_sampler.sample_paths_parallel(N=10,
                  policy=policy_stl[task_id],
                  num_cpu=num_cpu,
