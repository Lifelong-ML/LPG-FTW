...
job_name_ewc = 'tuning/ewc_std_shared_notscaled/halfcheetah_ewc_bodyparts_tuning'
...
for i in range(num_seeds):
      ...
      for ewc_lambda in lambda_range:   
            ...
            agent_ewc = NPGEWC(e, policy_ewc, baseline_ewc, ewc_lambda=ewc_lambda, scaled_lambda=False, normalized_step_size=1, seed=SEED, save_logs=True)
