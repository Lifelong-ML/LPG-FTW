...
job_name_pgella = 'results/walker_pgella_gravity_exp'
...
for i in range(num_seeds):
      ...
      agent_mtl = NPGFTW(e, policy_mtl, baseline_stl, normalized_step_size=0.1, seed=SEED, save_logs=True, new_col_mode='max_k')
