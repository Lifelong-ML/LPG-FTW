...
class MLPEWC:
    ...
    def set_task(self, task_id):
        ...
        self.trainable_params += list(self.model.fc_out[self.task_id].parameters())
        self.old_params = list(self.old_model.parameters()) + [self.old_log_std[self.task_id]]
        self.old_params += list(self.old_model.fc_out[self.task_id].parameters())
...
class MuNet(nn.Module):
    def __init__(self, obs_dim, act_dim, hidden_sizes, 
        ...
        self.d = ((obs_dim + 1) * hidden_sizes[0]
