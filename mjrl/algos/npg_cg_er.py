...
from mjrl.algos.batch_reinforce_er import BatchREINFORCEER


class NPGER(BatchREINFORCEER):
    ...
    def train_from_paths(self, paths):
        ...
        surr_after = self.CPI_surrogate(observations, actions, advantages, len(paths)).data.numpy().ravel()[0]
